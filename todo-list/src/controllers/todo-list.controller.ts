...
export class TodoListController {
  ...
  async find(): Promise<TodoList[]> {
    return this.todoListRepository.find(this.todoListRepository.filterTodoList());
  }
  ...
  async findById(
    ...
    return this.todoListRepository.findById(id, this.todoListRepository.filterTodoList());
  }
